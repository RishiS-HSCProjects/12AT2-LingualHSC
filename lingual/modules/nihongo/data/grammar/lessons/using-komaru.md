...
slug: using-komaru
tags: ["komaru", "expression", "difficulty"]
summary: Learn how to use the ～こまる construction in Japanese to express difficulty or trouble in doing something.

---

To express that you are troubled, annoyed, or having difficult time doing something in Japanese, you can use the verb ～困[こま]る in combination with the ～て form of another verb. This construction indicates that the action described by the first verb is causing you difficulty or trouble.

:::blockquote Verb (て-form) + 困[こま]る :::
:::blockquote Adjective (て-form) + 困[こま]る :::
...
- 仕事に行かないといけなくて、雨[あめ]が降[ふ]って困[こま]る。→ I have to go to work, and the rain is making it difficult.
